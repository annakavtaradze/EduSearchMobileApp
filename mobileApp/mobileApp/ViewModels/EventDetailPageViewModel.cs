...
namespace mobileApp.ViewModels
{
    ...
    public class EventDetailPageViewModel : BaseViewModel
    {
        ...
        private static EventDetailPageViewModel eventDetailViewModel;
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="EventDetailPageViewModel" /> class.
        /// </summary>
        ...
        /// </summary>
        public static EventDetailPageViewModel BindingContext =>
            eventDetailViewModel = PopulateData<EventDetailPageViewModel>("detail.json");
        ...
        {
            if (obj != null && (obj is EventDetailPageViewModel))
            {
                (obj as EventDetailPageViewModel).IsFavourite = (obj as EventDetailPageViewModel).IsFavourite ? false : true;
            }
        }
